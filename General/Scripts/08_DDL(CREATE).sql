...
/* 자료형
    ...
    ** VARCHAR2 주위사항 **
    ...
    NVARCHAR2(크기) : "가변" 길이 문자형 (4000BYTE)
...
-- 컬럼 레별 : 테이블 생성 시 생성할 컬럼의 정보를 작성하는 부분
...
--ORA-00001: 무결성 제약 조건(KH_YJS.USER_ID_U)에 위배됩니다
...
INSERT INTO USER_USED_UK
VALUES(1, NULL, 'pass01', '나길동', '남', '010-1234-5678', 'hong123@kh.or.kr');
--> ORA-00001: 무결성 제약 조건(KH_YJS.USER_NAME_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_YJS.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_YJS.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_YJS"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_YJS.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("KH_YJS"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_FK(
  ...
  GRADE_CODE NUMBER -- 해당 컬럼에 작성될 수 있는 값은
            -- USER_GRADE 테이블의 PK컬럼 값(GRADE_CODE)만 작성하게 제한하고 싶다!
            --> FK 제약조건 설정
...
-- ORA-02291: 무결성 제약조건(KH_YJS.GRADE_CODE_FK1)이 위배되었습니다
-- - 부모 키가 없습니다
...
FROM USER_GRADE
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(KH_YJS.GRADE_CODE_FK1)이 위배되었습니다
-- - 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(KH_YJS.GENDER_CHECK)이 위배되었습니다
...
VALUES(1, 'user01', 'pass01', '999999-9999999', '남', '010-1234-5678', '서울시 중구', 'N');

INSERT INTO USER_TEST
VALUES(2, 'user02', 'pass02', '888888-8888888', '남', '010-4534-5123', '경기도 화성시', 'Y');

INSERT INTO USER_TEST
VALUES(3, 'user03', 'pass03', '777777-7777777', '여', '010-8968-9504', '서울시 성북구', 'N');

INSERT INTO USER_TEST
VALUES(4, 'user04', 'pass04', '666666-6666666', '여', '010-1254-8768', '경기도 수원시', 'Y');

INSERT INTO USER_TEST
VALUES(5, 'user05', 'pass05', '555555-5555555', '남', '010-9654-9009', '강원도 영월군', 'N');
